    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Atualização de Cadastro de PET Desaparecido</h2>
          <ol>
            <li><a href="index_adm.php">Home</a></li>
            <li>Acesso Restrito</li>
            <li>Atualizar Cadastro de PET Desaparecidos</li>
          </ol>
        </div>
    ...
    <?php
        ...
        if($rs->execute()){
                if($rs->rowCount() > 0){
                    ...
                    ?>
<form method="POST" action="update_desaparecidos_img.php" enctype="multipart/form-data">
  <div class="card-body" align="center"> <?php echo "<img src='fotos/".$row->foto."' alt='Foto de exibição' width='400' height='500' /><br />"; ?></div>
    <br><br>
    <h2>Dados do PET</h2><br>
    <input type="text" name="cod" class="form-control" hidden value="<?php echo $row->cod; ?>">
  <div class="form-group">
    ...
    <input type="text" name="ultima_localizacao_pet" class="form-control" value="<?php echo $row->ultima_localizacao_pet; ?>">
    <input type="text" name="bairro_pet" class="form-control" value="<?php echo $row->bairro_pet; ?>">
    <input type="text" name="cidade_pet" class="form-control" value="<?php echo $row->cidade_pet; ?>">
  </div>
  <div class="form-group">
    ...
    <input type="text" name="nome_tutor" class="form-control" value="<?php echo $row->nome_tutor; ?>">
  </div>
    <div class="form-group">
    <label>Data de Nascimento:</label>
    <input type="text" name="dt_nasc_tutor" class="form-control" value="<?php echo $row->dt_nasc_tutor; ?>">
  </div>
  <div class="form-group">
    <label>Endereço:</label>
    <input type="text" name="endereco_tutor" class="form-control" value="<?php echo $row->endereco_tutor; ?>">
  </div>
  <div class="form-group">
    <label>Telefone:</label>
    <input type="text" name="telefone_tutor" class="form-control" value="<?php echo $row->telefone_tutor; ?>">
  </div>
    <div class="form-group">
  ...
  <a href="tela_pets_abandonados.php" class="btn btn-warning" role="button" >Cancelar</a>
  </div>
  <br><br>  
</form>
</div>
