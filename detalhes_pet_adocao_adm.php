    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Edição de Cadastro de PET para ADOÇÃO</h2>
        </div>
...
<form method="POST" action="update_efetivo_img.php" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input type="text" name="localizacao_pet" class="form-control" disabled="" value="<?php echo $row->localizacao_pet; ?>">
  </div>
  <div class="form-group">
    <label>Castração</label>
    <input type="text" name="castracao" class="form-control" disabled="" value="<?php echo $row->castracao_pet; ?>">
  </div>
  <div class="form-group">
    <label>Vacinação</label>
    <input type="text" name="vacinacao" class="form-control" disabled="" value="<?php echo $row->vacinacao_pet; ?>">
  </div>
    <div class="form-group">
  ...
  <br>
  <div align="center">
  <a href="tela_pets_adocao.php" class="btn btn-warning" role="button" >Voltar</a>
  </div>
  <br><br>  
</form>
</div>
