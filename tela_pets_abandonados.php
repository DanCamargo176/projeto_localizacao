...
<body>
	...
	$rs = $conn->prepare("SELECT * FROM tb_desaparecidos");;
		if($rs->execute()){
				if($rs->rowCount() > 0){?>
					...
					<div class="thumbnail" style="width: 20rem;"> 
							<center>
							  <div class="card-body"><?php echo "<img src='fotos/".$row->foto."' alt='Foto de exibição' width='200' height='300' /><br />"; ?>
									...
									<p class="card-text"><?php echo $row->ultima_localizacao_pet . "<br />"; ?></p>
                  <p class="card-text"><?php echo $row->bairro_pet . "<br />"; ?></p>
                  <p class="card-text"><?php echo $row->cidade_pet . "<br />"; ?></p>
									<?php echo "<a href='detalhes_pet_desaparecidos_adm.php?id=".$row->cod."'' class='btn btn-warning' role='button''>Ver Mais</a><br><hr>";?>
									<?php echo "<a href='editar_pet_desaparecidos_adm.php?id=".$row->cod."'' class='btn btn-warning' role='button''>Atualizar</a><br><hr>";?>
									<?php echo "<a href='delete_pet_desaparecidos_adm.php?id=".$row->cod."'' class='btn btn-warning' role='button''>Excluir</a><br><hr>";?>				
							  </div>
							</center>
					 </div>		  
