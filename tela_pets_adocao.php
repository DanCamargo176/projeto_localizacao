...
<body>
	...
	$rs = $conn->prepare("SELECT * FROM tb_adocao");;
		if($rs->execute()){
				if($rs->rowCount() > 0){?>
				...
				<div class="row">
					...
					<div class="thumbnail" style="width: 20rem;"> 
							<center>
							  <div class="card-body"><?php echo "<img src='fotos/".$row->foto_pet."' alt='Foto de exibição' width='200' height='300' /><br />"; ?>
									...
									<?php echo "<a href='detalhes_pet_adocao_adm.php?id=".$row->id."'' class='btn btn-warning' role='button''>Ver Mais</a><br><hr>";?>
									<?php echo "<a href='editar_pet_adocao_adm.php?id=".$row->id."'' class='btn btn-warning' role='button''>Atualizar</a><br><hr>";?>
									<?php echo "<a href='delete_pet_adocao_adm.php?id=".$row->id."'' class='btn btn-warning' role='button''>Excluir</a><br><hr>";?>				
							  </div>
							</center>
					 </div>		  
