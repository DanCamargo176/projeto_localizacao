      ...
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <ol>
            ...
            <li>Cadastro de Pet para Adoção</li>
          </ol>
        </div>
...
<div class="container">
<form method="POST" action="insere_pet_adocao.php" enctype="multipart/form-data">
    <br><br>
  ...
  <div class="form-group">
    ...
    <input type="text" name="localizacao_pet" class="form-control" placeholder="Exemplo: Rua das Dores, nº900">
  </div>
    <div class="form-group">
    <label>Castração:</label>
    <input type="text" name="castracao_pet" class="form-control" placeholder="Exemplo: Sim/Não">
  </div>
    <div class="form-group">
    <label>Vacinação:</label>
    <input type="text" name="vacinacao_pet" class="form-control" placeholder="Exemplo: Sim/Não">
  </div>
    <div class="form-group">
    <label>Informações adicionais do PET:</label>
