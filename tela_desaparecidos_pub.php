    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>PET's Desaparecidos<a href="cad_pet.php"><img src="assets/img/add.png"  width="50" height="50"></a></h2>
          <form method="get">
          <div class="row my-4">
...
<body>
  ...
  <!---->
	...
	$rs = $conn->prepare("SELECT * FROM tb_desaparecidos");;//prepara a conexao atraves do pdo com o banco de dados
		if($rs->execute()){//executa a query preparada acima
				...
				<div class="row">
					...
					<div class="thumbnail" style="width: 20rem;"> 
							<center>
							  <div class="card-body"><?php echo "<img src='fotos/".$row->foto."' alt='Foto de exibição' width='200' height='300' /><br />"; ?><br>
                  ...
                  <!--<a href="tela_efetivo.php" class="btn btn-primary" role="button" >Voltar</a>-->
									<?php echo "<a href='detalhes_pet_desaparecido.php?id=".$row->cod."'' class='btn btn-warning' role='button''>Ver Mais</a><br><hr>";?>				
							  </div>
							</center>
					 </div>		  
