    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Edição de Cadastro de VOLUNTÁRIOS<a href="cad_voluntarios_adm.php"><img src="assets/img/add.png"  width="50" height="50"></a></h2>
        </div>
...
<form method="POST" action="update_efetivo_img.php" enctype="multipart/form-data">
  ...
  <h2>Dados Pessoais</h2><br>
    ...
    <input type="text" name="id" class="form-control" disabled="" hidden  value="<?php echo $row->id; ?>">
    <label>Nome</label>
    <input type="text" name="nome" class="form-control" disabled="" value="<?php echo $row->nome; ?>">
  </div>
    <div class="form-group">
    <label>Data de Nascimento</label>
    <input type="text" name="data_nasc" class="form-control" disabled="" value="<?php echo $row->data_nasc; ?>">
  </div>
  <div class="form-group">
    <label>Endereço</label>
    <input type="text" name="endereco" class="form-control" disabled="" value="<?php echo $row->endereco; ?>">
  </div>
  <div class="form-group">
    <label>RG</label>
    <input type="text" name="rg" class="form-control" disabled="" value="<?php echo $row->rg; ?>">
  </div>
  <div class="form-group">
    <label>CPF</label>
    <input type="text" name="cpf" class="form-control" disabled="" value="<?php echo $row->cpf; ?>">
  </div><br>
  <h2>Dados de Contato</h2><br>
  <div class="form-group">
    <label>Celular</label>
    <input type="text" name="celular" class="form-control" disabled="" value="<?php echo $row->celular; ?>">
  </div>
  <div class="form-group">
    <label>E-mail</label>
    <input type="text" name="email" class="form-control" disabled="" value="<?php echo $row->email; ?>">
  </div>
    <div class="form-group">
  ...
  <br>
  <div align="center">
  <a href="tela_voluntarios.php" class="btn btn-warning" role="button" >Voltar</a>
  </div>
  <br><br>  
</form>
</div>
