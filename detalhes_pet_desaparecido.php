...
<form method="POST" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <row><input type="text" name="ultima_localizacao_pet" class="form-control" disabled="" value="<?php echo $row->ultima_localizacao_pet; ?>">
          <input type="text" name="bairro_pet" class="form-control" disabled="" value="<?php echo $row->bairro_pet; ?>">
          <input type="text" name="cidade_pet" class="form-control" disabled="" value="<?php echo $row->cidade_pet; ?>">
    </row>
  </div><br>

    <div class="form-group">
    <label>Nome (tutor):</label><br>
    <input type="text" name="nome_tutor" class="form-control" disabled="" value="<?php echo $row->nome_tutor; ?>"><br>
    <label>Telefone (tutor):</label><br>
    <input type="text" name="telefone_tutor" class="form-control" disabled="" value="<?php echo $row->telefone_tutor; ?>"><br>
  </div>
  <div class="form-group">
  ...
  <br>
  <div align="center">
  <a href="tela_desaparecidos_pub.php" class="btn btn-warning" role="button" >Voltar</a>
  </div>
  <br><br>  
</form>
</div>
